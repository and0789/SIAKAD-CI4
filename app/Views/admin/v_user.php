                    ...
                    foreach ($user as $key => $value) { ?>
                        <tr>
                            ...
                            <td class="text-center">
                                <img src="<?= base_url('photo/' . $value['foto']) ?>"
                            ...
                            <td class="text-center">
                                <button class="btn btn-warning btn-sm btn-flat"
                                        data-toggle="modal"
                                        data-target="#edit<?= $value['id_user'] ?>">
                                    <i class="fa fa-pencil"></i>
                                </button>
                                <button class="btn btn-danger btn-sm btn-flat"
                                        data-toggle="modal"
                                        data-target="#delete<?= $value['id_user'] ?>">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="nama_user" class="form-control" placeholder="NamaUser">
                </div>
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <img src="<?= base_url('photo/' . $value['foto']) ?>" class="img-circle" width="100px" height="100px">
                    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    Apakah Anda Yankin Ingin Menghapus <?= $title ?> <b><?= $value['nama_user'] ?> ? </b>
